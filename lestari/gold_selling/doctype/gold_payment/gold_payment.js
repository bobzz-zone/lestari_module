...
frappe.ui.form.on('Stock Payment', {
	item:function(frm,cdt,cdn) {
		...
		frappe.call({
			...
			callback: function (r){
				...
				frappe.model.set_value(cdt, cdn,"amount",Math.floor(parseFloat(r.message.nilai)/100*d.qty*1000)/1000);
	...
	qty:function(frm,cdt,cdn) {
		...
		frappe.model.set_value(cdt, cdn,"amount",(Math.floor((d.rate/100*d.qty)*1000)/1000));
